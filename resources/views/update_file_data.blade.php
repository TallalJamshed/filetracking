...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form class="form-horizontal" method="POST" action="{{route('updatefilesindb')}}">
                    @csrf
                    <div class="row clearfix farowtopmargin">
                        ...
                        {{-- <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5" >
                            <div class="form-group" style="font-weight:600; float:right">
                                <input type="text" class="form-control" id="ref_initial" value="PMAS/AAUR/" disabled >
                            </div>
                        </div> --}}
                        <input type="text" hidden name="completeref_no" id="completeref_no">
                        <input type="number" hidden name="prev_track_id" id="track_id">
                        
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <select name="file_id" id="file_id"  class="form-control addfileselect2" style="">
                                    <option value=""></option>
                                    @foreach ($filesdata as $file)
                                        <option value={{$file->file_id}} data-track_id={{$file->track_id}} data-ref_no={{$file->reference_no}}>{{$file->reference_no}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3"></div>
                        {{-- <div class="col-lg-2 col-md-12 col-sm-12 col-xs-12 form-control-label">
                            <label for="reference_no">New Reference</label>
                        </div> --}}
                        {{-- <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="form-line">
                    ...
                    <div class="row clearfix farowtopmargin">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <select name="fk_faculty_id" id="fk_faculty_id"  class="form-control addfileselect2" style="">
                                    <option value=""></option>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <select name="fk_department_id" id="fk_department_id"  class="form-control addfileselect2" disabled>
                    ...
                    <div class="row clearfix farowtopmargin">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <select name="fk_position_id" id="fk_position_id"  class="form-control addfileselect2" >
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="track_name" name="track_name"  class="form-control" placeholder="Enter name">
                                </div>
                                @error('track_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
